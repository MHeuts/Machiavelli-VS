...
Game::Game() noexcept
{
	...
	std::ifstream c_stream{ "Assets/karakterkaarten.csv" };
	c_stream >> character_deck;
	c_stream.close();

	std::ifstream b_stream{ "Assets/Bouwkaarten.csv" };
...
{
	std::string message =  Socket::endl + "Your opponent disconnected, the game ended." + Socket::endl;
