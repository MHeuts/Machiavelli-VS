...
mage_trade_state::mage_trade_state() : mage_trade_state(nullptr)
{
}

mage_trade_state::mage_trade_state(const std::shared_ptr<State>& old_state) : State(old_state)
{
}

void mage_trade_state::enter_state()
{
	trade_cards = std::vector<std::shared_ptr<building_card>>();
	Game::instance()->current_client->render_screen();
}

void mage_trade_state::render(std::shared_ptr<ClientInfo>& client)
{
	client->send_header();
...
void mage_trade_state::handle_input(std::shared_ptr<ClientCommand>& command)
{
...
std::string mage_trade_state::cards_view() const
{
...
int mage_trade_state::number_cards() const
{
